                    ...
                    <div class="px-5" x:data="sizeList">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="mb-5 flex items-center gap-2">
                                @can('floor-plan.delete')
                                    <button type="button" class="btn btn-danger gap-2 delete-button" @click="deleteRow()" data-href = "{{action('FloorPlaneController@destroy')}}">
                                ...
                                @endcan
                                @can('floor.view')    
                                    <a class="btn btn-info gap-2" href="{{ action('FloorController@index') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                                            <line x1="12" y1="5" x2="12" y2="19"></line>
                            ...
                            <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                ...
                                <div class="flex items-start justify-center min-h-screen px-4"
                                    ...
                                    <div x-transition x-transition.duration.300
                                        ...
                                        <div class="heading">
                                            <h2 class="m-0">Add Floor Plan</h2>
                                        </div>
                                        <div class="p-5">
                                            {!! Form::open(['url' => action('FloorPlaneController@store'), 'method' => 'post', 'class' => 'space-y-5', 'id' => 'facilityi6_add_form' ]) !!}
                                                <div>
                            ...
                            <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                ...
                                <div class="flex items-start justify-center min-h-screen px-4"
                                    ...
                                    <div x-transition x-transition.duration.300
                                        class="panel border-0 p-0 rounded-lg overflow-hidden my-8 w-full max-w-lg">
                                        <div class="heading">
                                            <h2 class="m-0">Edit Floor Plane</h2>
                                        </div>
                                        <div class="p-5">
                                            {!! Form::open(['url' => action('FloorPlaneController@update', ['ID']),'class'=>'space-y-5', 'method' => 'PUT', 'id' => 'call_edit_form' ]) !!}
                                                <div>
                                                    {!! Form::label('floor_id', __('Floor') . ':*') !!}
                                                    {!! Form::select('floor_id', $floors, null, ['class' => 'form-input', 'id'=>'seachable-select',
                                                        'placeholder' => __('Select Floor'),
                                                        'required', 'x-model'=>'itemToEdit.floor_id']); !!}
                                                </div>
                                                <div>
                                                    {!! Form::label('start_room_no', __('Start Room No') . ':*') !!}
                                                    {!! Form::number('start_room_no', null, ['class' => 'form-input',
                                                    'required', 'x-model'=>'itemToEdit.start_room_no']); !!}
                                                </div>
                                                <div>
                                                    {!! Form::label('no_of_rooms', __('No Of Rooms') . ':*') !!}
                                                    {!! Form::number('no_of_rooms', null, ['class' => 'form-input',
                                                        'required', 'x-model'=>'itemToEdit.no_of_rooms']); !!}
                                                </div>
                            ...
                            <tbody>
                                <template x-for="(item, index) in paginatedFilteredItems" :key="item.id">
                                    <tr>
                                        ...
                                        <td>
                                            <span x-text="item.start_room_no"></span>
                                        </td>
                                        <td>
                                            <span x-text="item.no_of_rooms"></span>
                                        </td>
                                        @can('floor-plan.update') 
                                        <td>
