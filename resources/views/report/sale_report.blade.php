            ...
            <div>
                <div class="panel border-[#e0e6ed] px-0 dark:border-[#1b2e4b]">
                    <div class="px-5" x:data="sizeList">
                        ...
                        <div   class="flex" style="position: absolute;margin-left: 537px;margin-top: 28px;z-index:9;">
                        ...
                        <!-- <div  class="flex" style="position: absolute;margin-left: 396px;margin-top: 28px;z-index:9;">
                            <select name="department" class="form-input" width="25%" id="select-department">
...
<script type="text/javascript">
    ...
    $('#product_sr_date_filter').on('cancel.daterangepicker', function(ev, picker) {
        ...
        var ajax_url = "{{action('SaleReportController@index')}}";
        facility_table = $('#facility_table').DataTable({
            ...
            "ajax": {
                ...
                "data": function ( d ) {
                    ...
                    d.start_date = start;
                    d.end_date = end;
                    d.department = $('#select-department').val();
        ...
        $('#select-department, #select-employee, #product_sr_date_filter').change(function () {
            facility_table.ajax.reload();
        ...
        function salesRepresentativeTotalSales() {
            ...
            var data_expense = {
                ...
                employee: $('select#select-employee').val(),
            }

            $('span#sr_total_sales').html(__fa_awesome());
            var sale_url = "{{action('SaleController@getSalesTotalSell')}}";
            $.ajax({
                method: "GET",
                url: sale_url,
                dataType: "json",
        ...
        $(document).on('click', 'tr.clickable_td', function() {
