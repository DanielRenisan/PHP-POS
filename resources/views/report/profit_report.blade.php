            ...
            <div>
                <div class="panel border-[#e0e6ed] px-0 dark:border-[#1b2e4b]">
                    <div class="px-5" x:data="sizeList">
                        ...
                        <div   class="flex" style="position: absolute;margin-left: 400px;margin-top: 28px;z-index:9;">
...
<script type="text/javascript">
    ...
    $('#product_sr_date_filter').on('cancel.daterangepicker', function(ev, picker) {
        ...
        var ajax_url = "{{action('ProfitReportController@profitReport')}}";
        ...
        $('#select-product, #product_sr_date_filter').change(function () {
            facility_table.ajax.reload();
        });
    });
</script>
