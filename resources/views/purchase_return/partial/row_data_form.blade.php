                                ...
                                <table  id="purchase_entry_table" class="whitespace-nowrap">
                                    ...
                                    @foreach($transaction->lines_of_purchase ?? [] as $line)
                                        ...
                                        <tr data-id="{{$line->id}}">
                                            ...
                                            <td>
                                                <input type="checkbox" id="check-box" class="form-checkbox" value="{{$line->id}}"/>
                                            </td>
                                            <td>
                        ...
                        <div class="grid grid-cols-2" style="margin-top: 20px; gap: 150px;">
                            ...
                            <div class="right" style="background-color: #f9f9f9; border-radius: 5px; padding: 20px;">
                                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 10px;">
                                    ...
                                    <span id="total_subtotal_return" class="display_currency"></span>
									<!-- This is total before purchase tax-->
                                    {!! Form::hidden('final_total', 0 , ['id' => 'grand_total_hidden_return']); !!}
									<input type="hidden" id="total_subtotal_input_return" value=0  name="total_before_tax">
                                    <!-- <input type="text" class="form-input" > -->
                                </div>
                                
                                <div style="display: flex; align-items: center; gap: 20px;">
                                    <label style="width: 30%;" for="returnType">Grand Total</label>
                                    <span id="grand_total_text_return" class="display_currency">0</span>
                                </div>
                            </div>
                        </div>
