...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <span>Edit Checkin</span>
            </li>
        </ul>
        {!! Form::open(['url' => action('CheckinController@update', $transaction->id), 'method' => 'PUT', 
...
<script>
    ...
    function cal_total_payable(value)
    {
        ...
        $('input#final_total_input').val(total.toFixed(2));
    ...
    function get_row_total()
    {
        ...
        $('input#final_total_input').val(total.toFixed(2)); // raw number
        $('span#total_payable').text(__currency_trans_from_en(total, true)); // formatted display
