            ...
            <div x-data="menu">
                <div class="panel">
                    <div>
                        ...
                        <div style="display: flex; gap: 10px; margin-top: 20px; height: 470px; overflow: auto;">
                            ...
                            <div x-show="currentStatus === 'ready'">
                                <div class="grid grid-cols-4 gap-2">
                                    <template x-for="order in orders">
                                        <template x-for="(item, keyOrder) in order.items" :key="keyOrder">
...
<script type="text/javascript">
    document.addEventListener("alpine:init", () => {
        Alpine.data("menu", () => ({
            ...
            //         orderNo: 1,
            //         name: "Burger",
            //         variations: ["premium white rice", "spicy mayo"],
            //         qty: 1,
            //         price: 10,
            //         time: "2024-02-05",
            //         status: "ready",
            ...
            //         orderNo: 2,
            //         name: "Fries",
            //         variations: ["Tomato", "Hummus Scoop"],
            //         qty: 1,
            //         price: 5,
            //         time: "2024-02-05",
            //         status: "pending",
