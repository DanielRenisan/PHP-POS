                    ...
                    <div class="px-5" x:data="categoryList">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="mb-5 flex items-center gap-2">
                                @can('wakeup.delete')
                                    <button type="button" class="btn btn-danger gap-2 delete-button" @click="deleteRow()" data-href = "{{action('WakeUpController@destroy')}}">
                            ...
                            <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                ...
                                <div class="flex items-start justify-center min-h-screen px-4"
                                    ...
                                    <div x-transition x-transition.duration.300
                                        ...
                                        <div class="heading">
                                            <h2 class="m-0">Add Wakeup Call</h2>
                                        </div>
                                        <div class="p-5">
                                        {!! Form::open(['url' => action('WakeUpController@store'), 'method' => 'post', 'class' => 'space-y-5', 'id' => 'call_add_form' ]) !!}
                                        
                                                <div>
                                                    <label for="code">Customer Name</label>
                                                    {!! Form::select('customer_id', $customers, null, ['class' => 'form-select text-white-dark', 'id'=>'seachable-select',
                                                                                'placeholder' => __('Select Customer'),'required']); !!}
                                                </div>
                                                <div>
                                                    <label for="ctnSelect1">Wake Up At</label>
                                                    <input class="form-input" name="wake_up_at" type="datetime-local" value="">
                                                </div>
                                                <div>
                            ...
                            <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                ...
                                <div class="flex items-start justify-center min-h-screen px-4"
                                    ...
                                    <div x-transition x-transition.duration.300
                                        class="panel border-0 p-0 rounded-lg overflow-hidden my-8 w-full max-w-lg">
                                        <div class="heading">
                                            <h2 class="m-0">Edit Call</h2>
                                        </div>
                                        <div class="p-5">
                                            {!! Form::open(['url' => action('WakeUpController@update', ['ID']),'class'=>'space-y-5', 'method' => 'PUT', 'id' => 'call_edit_form' ]) !!}
                                                <div>
                                                    <label for="code">Customer Name</label>
                                                    {!! Form::select('customer_id', $customers, null, ['class' => 'form-select text-white-dark', 'id'=>'seachable-select',
                                                        'placeholder' => __('Select Customer'),'required', 'x-model'=>'itemToEdit.customer']); !!}
                                                </div>
                                                <input id="edit-id" type="hidden" x-model="itemToEdit.id">
                                                <div>
                                                    <label for="ctnSelect1">Wake Up At</label>
                                                    <input class="form-input" name="wake_up_at" type="datetime-local" x-model="itemToEdit.date">
                                                </div>
                                                <div>
                                                    <label for="ctnSelect1">Remarks</label>
                                                    <textarea name="remarks" cols="30" rows="3" autocomplete="off" class="form-input" x-model="itemToEdit.remark"></textarea>
                                                </div>
