<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">Edit Wake Up Call</h4>
    </div>

    <div class="modal-body">
        <div class="form-group">
            {!! Form::label('customer_id', __('Customer') . ':*') !!}
            {!! Form::select('customer_id', $customers, $call->customer_id, ['class' => 'form-input', 'id'=>'seachable-select',
        ...
        <div class="form-group">
            ...
            <div x-data="form">
                <input id="dateTime" x-model="date2" class="form-input flatpickr-input active" name="wake_up_at" type="text" readonly="readonly" value="{{$call->wake_up_at}}">
            </div>
        </div>
        <div class="form-group">
            <label for="ctnSelect1">Remarks</label>
            <textarea name="remarks" cols="30" rows="3" autocomplete="off" class="form-input" placeholder="Remarks">{{$call->remarks}}</textarea>
        </div>
    </div>
