                    ...
                    <div class="px-5" x:data="sizeList">
                        ...
                        <div style="display:flex;gap: 0.875rem;">
                            ...
                            @can('purchase-payment.create')    
                                <button class="btn btn-primary gap-2 add-payment-btn"  style="display:none">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var ajax_url = "{{action('SaleController@index')}}";
        ...
        function salesRepresentativeTotalSales() {
            ...
            var sale_url = "{{action('SaleController@getInvoiceSalesTotal')}}";
            $.ajax({
                method: "GET",
                url: sale_url,
                dataType: "json",
