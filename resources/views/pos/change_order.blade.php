<div x-show.transition.duration.500ms="pickHeldInvoicePopup"
            ...
            class="popup" @click.away="pickHeldInvoicePopup = null"
    ...
    <div>
        ...
        left: 0;
        width: 100%;
        padding: 10px 20px;" class="menu-title">Change Order</h6>
    </div>
    <div style="margin-top: 35px;">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <template x-for="(invoice, invoiceIndex) in heldInvoices"
                            ...
                            <tr @click="returnHeldInvoice(invoiceIndex)" style="cursor: pointer;">
                                <td>
                        ...
                        <!-- Loop through heldOrders -->
                        <template x-for="(order, orderIndex) in heldOrders"
                            :key="'order-' + orderIndex">
                            <tr @click="returnHeldOrder(orderIndex)" style="cursor: pointer;">
                                <!-- <td style="font-weight: bold;">
                                    <span style="text-transform: capitalize;" x-text="order.no"></span>
                                </td> -->
                                <td>
                                    <span style="text-transform: capitalize;"
                                        x-text="order.location"></span>
                                </td>
                                <td style="font-weight: bold;">
                                    <span style="text-transform: capitalize;"
                                        x-text="order.invoiceNo"></span>
                                </td>
                                <td>
                                    <span style="text-transform: capitalize; margin-right: 10px;"
                                        x-text="order.type"></span>
                                </td>
                                <td>
                                    <span style="text-transform: capitalize;"
                                        x-text="order.cusName"></span>
                                </td>
                                <td>
                                    <span style="text-transform: capitalize;"
                                ...
                                <td>
                                    <span style="text-transform: capitalize;"
                                        x-text="order.lineTotal"></span>
                                </td>
                                <td>
                                    <span
                                        style="background-color: yellow; padding: 5px 20px; border-radius: 5px; width: fit-content; text-transform: uppercase;"
                                        x-text="order.status"></span>
                                </td>
                                <td colspan="4"></td> <!-- Empty columns for invoice-specific data -->
                            </tr>
                        </template>
                    </tbody>
                </table>
        ...
        <div
            ...
            <button type="button" class="btn btn-danger"
                @click="pickHeldInvoicePopup = null">Close</button>
        </div>
    </div>
</div>