<div x-show.transition.duration.500ms="userPopup"
    :class="{ 'popup-hidden': !userPopup, 'popup-visible': userPopup }" class="popup"
    @click.away="userPopup = null">
    <div>
        <div>
            <h6 style="
            background: skyblue;
            ...
            left: 0;
            width: 100%;
            padding: 10px 20px;" class="menu-title">Customer</h6>
        </div>
        <div style="margin: 35px 0;">
            ...
            <select class="form-select mt-3" name="customer" id="customer"
                x-model="selectedCustomer" @change="setCustomer($event.target.value)">
                <!-- <option selected value="all">All Customer</option> -->
        ...
        <div
            ...
            <button type="button" class="btn btn-danger"
                @click="userPopup = null">Close</button>
        </div>
    </div>
</div>