<div class="modal-dialog" role="document">
    ...
    {!! Form::open(['url' => action('HomeController@postExpense', $transaction->id), 'method' => 'post', 'id' => 'guest_add_form' ]) !!} 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div x-data="form">
                                        <input id="basicd" x-model="date1" class="form-input flatpickr-input active" name="transaction_date" type="text" readonly="readonly" value="{{isset($expense) ? $expense->transaction_date : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("alpine:init", () => {
            Alpine.data("form", () => ({
                ...
                init() {
                    flatpickr(document.getElementById('basicd'), {
                        dateFormat: 'Y-m-d',
