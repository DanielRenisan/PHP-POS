                    ...
                    <div class="px-5" x:data="sizeList">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="mb-5 flex items-center gap-2">
                                @can('booking.delete')
                                    <button type="button" class="btn btn-danger gap-2 delete-button" @click="deleteRow()" data-href = "{{action('CheckinController@destroy')}}">
                                ...
                                @endif
                                @can('booking.create')    
                                    <a href="{{action('BookingController@create')}}" class="btn btn-primary gap-2" @click="openModal = true">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex gap-4 items-center">
                                                ...
                                                <template x-if="item.new_status !== 'canceled'">
                                                    @can("booking.checkin")
                                                        <a x-bind:href="item.checkin_url" title="checkin"><i class="fa fa-check-square"></i></a>
                                                    @endcan
                                                </template>
                                                <template x-if="item.new_status !== 'canceled'">
                                                    @can("booking.update")
