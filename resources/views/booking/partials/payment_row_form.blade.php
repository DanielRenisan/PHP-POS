	...
	<div class="row grid grid-cols-2 gap-5">
		...
		<div style="align-items: center; gap: 20px;">
			<div class="form-group">
				...
				{!! Form::text("payment[$row_index][amount]", $payment_line['amount'], ['class' => 'form-input payment-amount input_number', 'required', 'id' => "amount_$row_index", 'placeholder' => __('Amount')]); !!}
			</div>
		</div>
		<div style="align-items: center; gap: 20px;">
			<div class="form-group">
