...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <div x-data="tablelist">
        ...
        <div class="panel border-[#e0e6ed] px-0 dark:border-[#1b2e4b]">
            <div class="px-5" x:data="tablelist">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div class="mb-5 flex items-center gap-2">
                        <button type="button" href="#" class="btn btn-danger delete-button"
                            data-href="{{ route('table_location.delete') }}" @click="deleteRow()">
                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="open && '!block'">
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div x-transition x-transition.duration.300
                                ...
                                <div class="heading">
                                    <h2 class="m-0">Add Table Location</h2>
                                </div>
                                <div class="p-5">
                                    <form id="signupForm" class="needs-validation" method="POST"
                                        action="{{ route('table_location.store') }}">
                                        @csrf


                                        <div>
                                            <label for="name">Name</label>
                                            <input id="Name" type="text" placeholder="Location Name" name="name"
                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="open && '!block'">
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div x-transition x-transition.duration.300
                                class="panel border-0 p-0 rounded-lg overflow-hidden my-8 w-full max-w-lg">
                                <div class="heading">
                                    <h2 class="m-0">Edit Table Location</h2>
                                </div>
                                <div class="p-5">

                                    <form id="signupForm" class="needs-validation" novalidate="" method="POST"
                                        action="{{ route('table_location.update') }}">
                                        @csrf
                                        ...
                                        <div>
                                            ...
                                            <input id="Name" type="text" class="form-input" name="name"
                                                x-model="itemToEdit.location_name" required />
                                        </div>
                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="open && '!block'">
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div x-transition x-transition.duration.300
                                class="panel border-0 p-0 rounded-lg overflow-hidden my-8 w-full max-w-lg">
                                <div class="heading">
                                    <h2 class="m-0">View Table Location</h2>
                                </div>
                                <div class="p-5">
                                    <div class="row" style="display: flex; gap: 30px;">
                                        <div class="centre" style="flex: 0%">
                                                <h2 style="display: flex; flex-direction: column; font-size: 12px;">
                                                    Name : <span class="form-input"
                                                        x-text="viewItem.location_name"></span></h2>
...
//Category list
        Alpine.data('tablelist', () => ({
            selectedRows: [],
            items:  <?php echo $tableLocation; ?>,            searchText: '',
            openModal: false,
            editModal: false,
            viewModal: false,
            viewItem: {},
