                    ...
                    <div class="grid grid-cols-4 gap-4">
                            ...
                            <div class="hotel-options"
                                ...
                                <div>
                                    <label>
                                        ...
                                        {{isset($contact) && ($contact->nationality_type == 'native' ||  $contact->nationality_type == null ) ? 'checked' : ''}}>
                                        Native
                                    </label>
                                </div>
                                <div>
                                    <label>
                                        <input type="radio" name="nationality_type"
                                            value="foreigner" {{isset($contact) && $contact->nationality_type == 'foreigner' ? 'checked' : ''}}>
                                        Foreigner
                                    </label>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input id="professional" type="text" name="professional" value="{{isset($contact) ? $contact->professional : ''}}"
                                    class="form-input" />
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input id="nationalId" type="text" class="form-input" value="{{isset($contact) ? $contact->national_id : ''}}"
                                    name="national_id" />
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input id="policeInfo" type="text" class="form-input" value="{{isset($contact) ? $contact->police_info : ''}}"
                                    name="police_info" />
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input id="nationality" type="text" name="nationality" value="{{isset($contact) ? $contact->nationality : ''}}"
                                    class="form-input" />
                            </div>
                        </div>
                        <div
                            ...
                            <div>
                                ...
                                <input id="passportNo" type="text" class="form-input" value="{{isset($contact) ? $contact->passport_no : ''}}"
                                    name="passport_no" />
                            </div>
                        </div>
                        <div
                            ...
                            <div>
                                ...
                                <input id="purposeVisit" type="text" name="purpose_of_visit" value="{{isset($contact) ? $contact->purpose_of_visit : ''}}"
                                    class="form-input" />
                            </div>
                        </div>
                        <div
                            ...
                            <div>
                                ...
                                <input id="visaRegNo" type="text" class="form-input"
                                    name="visa_no" value="{{isset($contact) ? $contact->visa_no : ''}}"/>
                            </div>
                        </div>
                        ...
                        <!-- <div>
                            ...
                            <select class="form-select text-white-dark" name="event_type"
                                ...
                                <option class="pro-type" value="{{ $et->id }}" {{isset($contact) && $contact->event_type == $et->id ? 'selected' : ''}}>
                                    {{ $et->name }}</option>
                                @endforeach
                            </select>
                        </div> -->
                        ...
                        <div>
                            ...
                            <select class="form-select text-white-dark" name="contact_group"
                                ...
                                {{isset($contact) && $contact->contact_group == $et->id ? 'selected' : ''}}>
                                    {{ $et->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <input id="creditPayment" type="text" class="form-input" value="{{isset($contact) ? $contact->credit_payment : ''}}"
                                name="credit_payment" />
                        </div>
                        <div>
                        ...
                        <div style="margin-top: 13px;">
                            ...
                            <input id="status" type="checkbox" class="form-checkbox" {{isset($contact) && $contact->status == 'Active' ? 'checked' : ''}}
                                name="status" />
                            <span>Active</span>
                        </div>
                    </div>
