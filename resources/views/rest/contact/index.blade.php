                ...
                <div class="px-5" x:data="categoryList">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div class="mb-5 flex items-center gap-2">
                            @can('contact.create')
                            <a class="btn btn-success gap-2" href="{{action('Rest\ContactController@create')}}">
...
<script type="text/javascript">
    $(document).ready(function () {
        var ajax_url = "{{action('Rest\ContactController@index')}}";
        facility_table = $('#facility_table').DataTable({
            ...
            columns: [
                ...
                { data: 'credit_payment', name: 'credit_payment'},
        ...
        $(document).on('click', "table#facility_table tbody tr td", function() {
            ...
            $(document).on('click', 'button.edit-btn', function() {
                ...
                const show_url = "{{action('Rest\ContactController@edit', ['ID'])}}".replace('ID', id);
