                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="open && '!block'">
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div x-transition x-transition.duration.300
                                ...
                                <div class="heading">
                                    <h2 class="m-0">Add Order Type</h2>
                                </div>
                                <div class="p-5">
                                    <form id="signupForm" class="needs-validation" method="POST"
                                        action="{{ route('order_type.store') }}">
                                        @csrf
                                        <div class="grid grid-cols-1 gap-4">
                                            <div>
                                                <label for="name">Name *</label>
                                                <input id="Name" type="text" placeholder="Order Name" name="name"
                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="open && '!block'">
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div x-transition x-transition.duration.300
                                class="panel border-0 p-0 rounded-lg overflow-hidden my-8 w-full max-w-lg">
                                <div class="heading">
                                    <h2 class="m-0">View Order Types</h2>
                                </div>
                                <div class="p-5">
...
//Category list
        Alpine.data('ordertypelist', () => ({
            selectedRows: [],
            items:  <?php echo $orderType; ?>,
            searchText: '',
            openModal: false,
            editModal: false,
            viewModal: false,
