<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('RoomDetailController@update', $detail->id), 'method' => 'PUT', 'id' => 'detail_edit_form' , 'files' => true]) !!}
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            {!! Form::select('room_facility_id', $facilities, $detail->room_facility_id, ['class' => 'form-input', 'id'=>'seachable-select',
        ...
        <div class="form-group">
            ...
            {!! Form::text('name', $detail->name, ['class' => 'form-input',
                'required']); !!}
        </div>
        <div class="form-group">
