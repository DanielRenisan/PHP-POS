<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('BookingController@updateCK', $transaction->id), 'method' => 'put', 'id' => 'add_form' ]) !!}
                    ...
                    <div class="mb-5">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div x-data="form">
                                    <input id="dateTime3" x-model="date2" class="form-input flatpickr-input active" name="check_in_at" type="text" readonly="readonly" value="{{$booking->check_in_at}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div x-data="form">
                                    <input id="dateTimeout3" x-model="date2" class="form-input flatpickr-input active" name="check_out_at" type="text" readonly="readonly" value="{{$booking->check_out_at}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="panel">
                    ...
                    <div class="flex flex-col gap-2.5 xl:flex-row">
                        <div class="col-md-4">
                            ...
                            data-href="{{action('GuestController@create')}}" 
                            data-container=".guest_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-5 fetch-div-0">
                        ...
                        <div class="tr row_set">
                            ...
                            <div class="flex flex-col gap-2.5 xl:flex-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Rent" class="form-input" name="room_detail[{{$kry}}][rent]" id="rent-input" value="{{$single_room->rent}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="h-px border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                            ...
                            <div class="flex flex-col gap-2.5 xl:flex-row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="number"  class="form-input" name="room_detail[{{$kry}}][number]" value="{{$single_room->number}}" id="complementry-no">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tr row_set">
                            <div class="flex flex-col gap-2.5 xl:flex-row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="ctnSelect1">Room No. <span class="text-danger">*</span></label>
                                        {!! Form::select('room_detail[0][room_no]', [] , null, ['class' => 'form-input', 'id' => 'room-no',
                                        'required']); !!}
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="flex flex-col gap-2.5 xl:flex-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="ctnSelect1">Check In <span class="text-danger">*</span></label>
                                        <input type="datetime-local" class="form-input" name="room_detail[0][check_in_at]" value="{{date('Y-m-d h:i')}}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="ctnSelect1">Check Out <span class="text-danger">*</span></label>
                                        <input type="datetime-local" class="form-input" name="room_detail[0][check_out_at]" value="{{date('Y-m-d h:i')}}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="flex flex-col gap-2.5 xl:flex-row">
                                ...
                                <div class="col-md-1">                   
                                    <input type="number" placeholder="Amount" class="form-input" name="room_detail[0][bed_amount]"  id="bed-amount" value="">
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <input type="number" placeholder="Child" class="form-input" name="room_detail[0][childs_count]" id="childs-count" value="">
                                </div>
                                <div class="col-md-1"  style="border-right: 1px solid black;">
                ...
                <div class="panel">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button type="submit" class="btn btn-warning mt-6">CHECKIN</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    var checkin = "{{$booking->check_in_at}}";
    var checkout = "{{$booking->check_out_at}}";
    document.addEventListener("alpine:init", () => {
        Alpine.data("form", () => ({
            date2: checkin,
            date3: checkout,
            init() {
                flatpickr(document.getElementById('dateTime3'), {
                    defaultDate: this.date2,
                    enableTime: true,
                    dateFormat: 'Y-m-d H:i'
                })
                flatpickr(document.getElementById('dateTimeout3'), {
    ...
    $(document).on('change','#dateTime3' ,function () {
        get_room_info();
        
    });
    $(document).on('change','#dateTimeout3' ,function () {
        get_room_info();
            ...
            '<div class="flex flex-col gap-2.5 xl:flex-row">'+
                        ...
                        '<div class="flex flex-col gap-2.5 xl:flex-row">'+
                            ...
                            '<div class="col-md-4">'+
                                '<div class="form-group">'+
                                    '<label for="ctnSelect1">Check Out <span class="text-danger">*</span></label>'+
                                    '<input type="datetime-local" class="form-input" name="room_detail['+index+'][check_out_at]" value="{{date("Y-m-d h:i")}}" required>'+
                                '</div>'+
                            '</div>'+
                            '<div class="col-md-4">'+
                                '<div class="form-group">'+
