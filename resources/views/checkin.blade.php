<div class="modal-dialog modal-xl" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('CheckinController@store'), 'method' => 'post', 'id' => 'add_form' ]) !!}
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div x-data="form">
                                <input id="dateTime1" x-model="date2" class="form-input flatpickr-input active" name="check_in_at" type="text" readonly="readonly" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div x-data="form">
                                <input id="dateTimeout2" x-model="date2" class="form-input flatpickr-input active" name="check_out_at" type="text" readonly="readonly" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="flex flex-col gap-2.5 xl:flex-row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="ctnSelect1">Check In <span class="text-danger">*</span></label>
                                    <div x-data="form">
                                        <input id="dateTime_date1" x-model="date2" class="form-input flatpickr-input active" name="room_detail[0][check_in_at]" type="text" readonly="readonly" disabled value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="ctnSelect1">Check Out <span class="text-danger">*</span></label>
                                    <div x-data="form">
                                        <input id="dateTime_in1" x-model="date2" class="form-input flatpickr-input active" name="room_detail[0][check_out_at]" type="text" readonly="readonly" disabled value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
...
<script>
    document.addEventListener("alpine:init", () => {
        Alpine.data("form", () => ({
            ...
            init() {
                flatpickr(document.getElementById('dateTime1'), {
                    defaultDate: this.date2,
                    enableTime: true,
                    dateFormat: 'Y-m-d H:i'
                })
                flatpickr(document.getElementById('dateTimeout2'), {
                    defaultDate: this.date2,
                    enableTime: true,
                    dateFormat: 'Y-m-d H:i'
                })
                flatpickr(document.getElementById('dateTime_in1'), {
                    defaultDate: this.date2,
                    enableTime: true,
                    dateFormat: 'Y-m-d H:i'
                })
                flatpickr(document.getElementById('dateTime_date1'), {
                    defaultDate: this.date2,
                    enableTime: true,
                    dateFormat: 'Y-m-d H:i'
                })
    ...
    $(document).on('change','#dateTime1' ,function () {
        get_room_info();
        $('#dateTime_date1').val($(this).val());
        
    });
    $(document).on('change','#dateTimeout2' ,function () {
        get_room_info();
        $('#dateTime_in1').val($(this).val());
    });
