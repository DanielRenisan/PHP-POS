                    ...
                    <div class="px-5">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="mb-5 flex items-center gap-2">
                                @can('purchase-wastage.create')    
                                    <a href="{{action('PurchaseWastageController@create')}}" class="btn btn-success gap-2">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var ajax_url = "{{action('PurchaseWastageController@index')}}";
        ...
        $(document).on('click', "table#facility_table tbody tr td", function() {
            ...
            $(document).on('click', 'button.view-btn', function() {
                ...
                $('button.view-btn').hide();
                const show_url = "{{action('PurchaseWastageController@show', ['ID'])}}".replace('ID', id);
                window.location.href = show_url;
            });
	    });
        // $(document).on('dblclick', 'tr#check-tr', function() {
        //     const id = $(this).data('id');
        //     const edit_url = "{{action('PurchaseWastageController@show', ['ID'])}}".replace('ID', id);
