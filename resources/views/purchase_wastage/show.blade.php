...
<div class="animate__animated p-6 no-print no-print" :class="[$store.app.animation]">
    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1"><a  href="{{action('PurchaseWastageController@index')}}">
                <span>Purchase Wastage</span></a>
            </li>
                                        ...
                                        <table class="table-striped">
                                            <thead>
                                                <tr>
                                                    <th class="">S.NO</th>
                                                    <th class="">Product</th>
                                                    <th class="">Purchase QTY</th>
                                                    <th class="ltr:text-right rtl:text-left">Wastage QTY.</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($transaction->lines_of_purchase as $kry => $line)
                                                    @php
                                                    $parent = $line->parent;
                                                    @endphp
                                                    <tr>
