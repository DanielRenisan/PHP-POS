...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::directive('job_status', function ($status) {
            return "<?php if($status == 'Holding'){
                echo 'bg-aqua';
            }elseif($status == 'Close'){
                echo 'bg-red';
            }elseif ($status == 'Open') {
        ...
        Blade::directive('resevation_status', function ($status) {
            return "<?php if($status == 'booking'){
                echo 'bg-aqua';
