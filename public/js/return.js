$(document).ready(function () {
	...
	$('button#pos-cancel').click(function () {
		swal({
			...
			if (willDelete) {
				reset_pos_form();
				window.location.href = "https://lapderfumerie.yalpos.com/pos/create";
			}
		});
	});
		...
		$.ajax({
			...
			success: function (result) {
				if (result.success == 1) {
					...
					window.location.href = "{{url('/pos/return/modifier',['ID'])}}".replace('ID', result.id);
...
function pos_total_row() {
	...
	$('table#pos_table tbody tr').each(function () {
		...
		return_total = return_total + __read_number($(this).find('input.return_line_total'));
		new_total = new_total + __read_number($(this).find('input.new_line_total'));
		price_total = new_total - return_total;
	});
