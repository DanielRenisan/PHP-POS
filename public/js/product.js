...
$(document).ready(function () {
	...
	var product_table = $('#product_table').DataTable({
		...
		columns: [
			...
			// { data: 'max_price', name: 'max_price' , "searchable": false},
			{ data: 'distribution_price', name: 'distribution_price' },
	...
	var img_fileinput_setting = {
		'showUpload': false, 'showPreview': true, 'browseLabel': LANG.file_browse_label, 'removeLabel': LANG.remove, 'previewSettings': {
